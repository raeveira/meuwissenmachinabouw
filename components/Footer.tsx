    ...
    <footer className="w-screen h-screen snap-start snap-always bg-white text-white flex flex-col justify-end relative">
      ...
      <div className="mx-auto px-4 pr-8 py-6 flex items-center justify-between min-w-[750px] max-h-[195px] bg-black rounded-t-xl absolute left-1/2 -translate-x-1/2 top-[30%]">
        <div className="flex items-center gap-4">
          ...
          <Image src={'/coffee.png'} alt={'cup of coffee'} width={256} height={256} className={'absolute -top-20 left-1/2 -translate-x-[65%] hover:-rotate-[20deg] hover:scale-125 transition-all duration-300'} />
        </div>
      ...
      <div className="container mx-auto px-4 py-12 bg-black pt-32">
        <div className="grid grid-cols-3">
          ...
          <div className={'flex flex-col gap-y-8 items-center'}>
            <Image src={'/Meuwissen-Machinebouw-logo-footer.png'} alt={'Meuwissen Machinebouw logo'} width={256} height={256} />
