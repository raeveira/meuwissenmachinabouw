                ...
                <Link href={'#drawing'}>
                    ...
                    >
                        <div
                            ...
                            <h2 className="m-0 -rotate-[150deg] text-black bg-white absolute -top-4 text-[6px] -right-2.5 w-[54px] h-[32px] text-center"><span className={'mr-4 text-[3.5px] absolute -top-[6px] left-[4px] rotate-[60deg] text-center items-center flex flex-col'}>VOLG ONS NAAR <br/> ONS SPEELVELD<br/> <ChevronDown size={6}/> </span></h2>
                        </div>
                    </div>
                </Link>
            </div>
